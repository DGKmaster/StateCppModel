    ...
    ui(new Ui::Widget)
{
    ...
    inputPlot->setFixedSize(
        this->width()/2,this->height());
    outputPlot->setFixedSize(
        this->width()/2,this->height());
    ...
    inputPlot->xAxis->setRange(
        0, object->SIMULATION_TIME);
    inputPlot->yAxis->setRange(-3, 3);
    outputPlot->xAxis->setRange(
        0, object->SIMULATION_TIME);
    ...
    //////////////////////////////////////
        ...
        startTime = tmpStruct.tv_sec 
        * 1000 + tmpStruct.tv_usec / 1000 + 0.5;
    #endif
    #ifdef _WIN32
        SYSTEMTIME tmpStruct;
        GetSystemTime(&tmpStruct);
        startTime = tmpStruct.wSecond 
        * 1000 + tmpStruct.wMilliseconds + 0.5;
    #endif
    //////////////////////////////////////
...
// generate some data:
    ...
    double tmp = (tmpTime.tv_sec * 1000 
    + tmpTime.tv_usec / 1000 + 0.5)-startTime;
#endif
#ifdef _WIN32
    SYSTEMTIME tmpTime;
    GetSystemTime(&tmpTime);
    double tmp = tmpTime.wSecond 
    * 1000 + tmpTime.wMilliseconds + 0.5 - startTime;
#endif
    ...
    output.append(
        object->update_continuous(
            signal, object->TIME_STEP));
    //////////////////////////////////////
    ...
    if (object->time_now > object->SIMULATION_TIME) {
        timer->stop();
    }
}
